...
/*   Updated: 2022/09/23 14:38:53 by gsever           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
step 1 git clone --depth=1 https://github.com/Homebrew/brew /goinfre/$USER/brew
&& echo 'export PATH=/goinfre/$USER/brew/bin:$PATH' >> $HOME/.zshrc

step 2 brew install readline
step 3 brew link --force readline
step 4 echo 'export C_INCLUDE_PATH="/goinfre/$USER/brew/include:$C_INCLUDE_PATH"'
>> ~/.zshrc
step 5 echo 'export LIBRARY_PATH="/goinfre/$USER/brew/lib:$LIBRARY_PATH"' >> ~/.zshrc
 * 
> Tanım:
